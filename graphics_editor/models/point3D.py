# graphics_editor/models/point3D.py
...
class Point3D:
    ...
    def __init__(self, x: float, y: float, z: float, color: Optional[QColor] = None):
        ...
        Inicializa um Point3D com coordenadas e cor.
    ...
    def to_qvector3d(self) -> QVector3D:
        ...
        Converte o Point3D para o formato QVector3D do Qt.
    ...
    def __repr__(self) -> str:
        ...
        Retorna uma representação textual do Point3D.


        Returns:

            str: String representando o Point3D com suas coordenadas e cor.
        """

        return f"Point3D(x={self.x:.3f}, y={self.y:.3f}, z={self.z:.3f}, color={self.color.name()})"

    def __eq__(self, other: object) -> bool:
        """Verifica se dois Point3D são iguais (baseado nas coordenadas)."""
